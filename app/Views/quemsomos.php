        ...
        <div class="container-fluid py-4 ">  <!-- Ocupa toda a largura -->
            <div class="card p-3 shadow-lg">
                <div class="card text-center shadow-lg p-3 mb-4 bg-blue">
                    <h3 class="fw-bold text-white">Quem somos nós</h3>
                </div>

                <div class="card shadow-lg p-3 text-align" style="text-align:center">
                    <div class="card-body">
                        <h5 class="card-title fw-bold text-primary">Equipe</h5><hr>
                        <p class="text-muted">
                            Nós somos um grupo de alunos da UNIP, atualmente estamos cursando Ciencias da Computação.
                            Estamos empolgados em transformar ideias em realidade e contribuir para o avanço da área da saúde por meio da tecnologia em nossa comunidade!
                        </p>
                    </div>
                </div>
                ...
                <div class="card shadow-lg p-3 text-align" style="text-align:center">
                    <div class="card-body">
                        <h5 class="card-title fw-bold text-primary">Habilidades</h5><hr>
                        <p class="text-muted">
                            Combinando nossas habilidades em programação e design, buscamos criar uma solução que não apenas atenda às necessidades da atividade, mas que também no futuro proporcione uma experiência unica para o publico alvo.
                        </p>
                    </div>
                </div>
    <br>
                <div class="card shadow-lg p-3 text-align" style="text-align:center">
                    <div class="card-body">
                        <h5 class="card-title fw-bold text-primary">Nosso Compromisso</h5><hr>
                        <p class="text-muted">
                            Estamos dedicados a criar um sistema eficiente, que facilite o gerenciamento de agendamento, otimizando processos e melhorando a experiência de pacientes e facilitar os funcionários de saúde.
                        </p>
                    </div>
                </div>
