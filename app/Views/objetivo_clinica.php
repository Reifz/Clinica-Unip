    ...
    <div class="container-fluid py-4 "> <!-- Ocupa toda a largura -->
        <div class="card p-3 shadow-lg">
            <div class="card text-center shadow-lg p-3 mb-4 bg-blue">
                <h3 class="fw-bold text-white">Objetivo da Clínica</h3>
            </div>

            <div class="card shadow-lg p-3 text-align" style="text-align:center">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary">Objetivo do Sistema</h5>
                    <hr>
                    <p class="text-muted">
                        Facilitar o acesso e o contato a serviços de saúde para a comunidade dentro de sua região,
                        especialmente idosos e pessoas com pouca familiaridade com tecnologia,
                        com o sistema permitindo o agendamento de consultas em clínicas próximas e o acesso a prévias
                        informações úteis sobre saúde e curiosidades.
            ...
            <div class="card shadow-lg p-3 text-align" style="text-align:center">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary">Público-alvo</h5>
                    <hr>
                    <p class="text-muted">
                        Idosos e pessoas com dificuldades em acessar ou compreender serviços de saúde digitalmente e
                        otimizar o tempo para o agendamento de consultas.
            ...
            <div class="card shadow-lg p-3 text-align" style="text-align:center">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary">Escopo</h5>
                    <hr>
                    <p class="text-muted">
                        O sistema permite que usuários agendem consultas em clínicas próximas por meio de um chatbot,
                        além de fornecer informativos prévios sobre saúde em geral, orientações sobre exames e
                        curiosidades médicas para melhorar o conhecimento da comunidade. Além de seus agendamentos, o
                        usuário poderá visualizar clínicas próximas de sua região e se informar melhor nas próximas
                        vezes em que o mesmo precisar dos serviços da saúde.
